...
enum stats_t {
	...
	STAT_FLAT_DAMAGE,
	STAT_FLAT_HEALING,
	STAT_LAST = STAT_FLAT_HEALING
};

enum combatBonusTypes_t {
	BONUS_FIRST = 0,
	BONUS_FLAT_DAMAGE = BONUS_FIRST,
	BONUS_PERCENT_DAMAGE = 1,
	BONUS_FLAT_HEALING = 2,
	BONUS_PERCENT_HEALING = 3,
	BONUS_LAST = BONUS_PERCENT_DAMAGE
};
